...
const PageMarketingNoItems = () => {
  ...
  const generateMbti = (category) => {
    ...
    const mbtiResult = {
      ...
      summary:
        mbti === "ROIC"
          ? "과감한 실행력과 창의력으로 위험을 두려워하지 않고 빠르게 기회를 잡는 멋진 타입이에요!"
          : mbti === "ROTC"
          ? "창의적 도전가로, 팀플레이를 통해 위험을 극복하며 목표를 향해 돌진하는 스타일이군요"
          : mbti === "SOIA"
          ? "기회가 오면 빠르게 잡되, 리스크를 최소화하며 안정적인 사업을 선호하는 타입!"
          : mbti === "RPTC"
          ? "팀과 함께 창의적 프로젝트에 도전하며 계획적으로 혁신적인 목표를 달성하는 스타일!"
          : mbti === "ROTA"
          ? "팀과 협력하여 빠르게 성장하며 성과를 내기 위해 과감히 위험을 감수하는 타입!"
          : mbti === "SPIC"
          ? "안정적인 환경에서 아이디어를 꼼꼼히 다듬고 창의적인 성과를 추구하는 타입이에요."
          : mbti === "SOTC"
          ? "팀과 함께 기회를 잡으며, 창의적인 프로젝트를 통해 성장을 목표로 하는 타입입니다."
          : mbti === "RPIA"
          ? "RPIA 유형은 독립적으로 계획을 실행하며 실용적 성과를 추구하는 현실주의 전략가!"
          : mbti === "ROIA"
          ? "빠르게 기회를 포착하고, 독립적으로 실용적인 결과를 추구하는 스타일입니다."
          : mbti === "SPTC"
          ? "안정적인 환경에서 팀과 함께 창의적인 아이디어를 실현하는 유형입니다."
          : mbti === "SPIA"
          ? "안정을 추구하면서도 독립적으로 실용적인 전략을 계획하고 실행하는 스타일입니다."
          : mbti === "RPTA"
          ? "팀과 협력하여 실용적인 목표를 위해 계획적으로 리스크를 감수하는 유형입니다."
          : mbti === "SOIC"
          ? "안정을 추구하면서도 독립적으로 창의적인 기회를 포착하는 스타일입니다."
          : mbti === "SOTA"
          ? "팀과 협력하여 안정적으로 실용적인 기회를 포착하는 스타일입니다."
          : mbti === "RPIC"
          ? "위험을 감수하면서도 독립적으로 창의적인 계획을 세우고 실행하는 모험적 창업가입니다."
          : mbti === "SPTA"
          ? "팀과 함께 실용적인 혁신을 추구하며, 계획적으로 리스크를 감수하는 유형입니다."
          : "",
      description:
        mbti === "ROIC"
          ? "불도저형 스타트업러는 대담하고 공격적인 전략을 선호하며, 높은 위험을 감수할 준비가 되어 있는 창업자에게 적합한 유형입니다. 이 유형은 빠르게 변화하는 시장에서 신속한 성장을 목표로 하며, 혁신적인 기술이나 아이디어를 추진합니다. 독립적인 실행력과 창의성으로 남다른 길을 개척해나갑니다."
          : mbti === "ROTC"
          ? "모험심 가득한 팀플레이 혁신가: ROTC 유형은 두려움 없이 새로움을 추구하는 창의적 도전가로, ‘팀플레이’를 통해 기회를 만들어내는 데 탁월합니다. 고위험의 거친 파도 속에서도 팀원들과 협력하며 기회를 포착하고, 창의적 아이디어를 무기로 목표를 향해 돌진합니다. 이들은 팀과 함께할 때 더 큰 에너지를 발휘하며, 새로운 방식으로 문제를 해결하는 데도 능합니다."
          : mbti === "SOIA"
          ? "기회만 보면 달려가는 신중형은 기회가 왔을 때 빠르게 잡되, 리스크 관리에도 신경을 쓰는 유형입니다. 안정적인 사업 운영을 중시하면서도 잠재적 이익을 놓치지 않으려는 창업자에게 적합하며, 안정과 기회 포착 사이의 균형을 유지하려고 노력합니다."
          : mbti === "RPTC"
          ? "팀플레이 혁신가는 팀과 함께 창의적 프로젝트에 도전하며, 계획적으로 리스크를 감수하면서 혁신적인 목표를 달성합니다. 협력과 혁신을 동시에 중시하는 이 유형은 팀원과의 조화로운 협업을 통해 큰 성과를 이끌어냅니다."
          : mbti === "ROTA"
          ? "팀과 함께 달리는 야심가는 빠른 성장과 성과 달성을 목표로, 고위험을 감수하면서도 팀과 협력하는 창업자 유형입니다. 강한 리더십과 추진력으로 팀과 함께 빠른 속도로 목표를 달성하고자 합니다."
          : mbti === "SPIC"
          ? "차근차근형 아이디어 매니아는 안정적인 환경에서 아이디어를 정성스럽게 다듬고 창의적인 성과를 추구합니다. 신중하면서도 새로운 아이디어에 대한 열정을 가진 유형으로, 안정적인 환경에서 꾸준히 성과를 이루려는 창업자에게 잘 맞습니다."
          : mbti === "SOTC"
          ? "기회형 팀 도전자는 팀과 함께 기회를 발견하고 창의적인 프로젝트로 성장을 목표로 합니다. 리스크를 최소화하면서도 혁신을 통해 새로운 가능성을 추구하는 유형입니다."
          : mbti === "RPIA"
          ? "혼자서도 멋진 현실주의 전략가: RPIA 유형은 무작정 도전하기보다는 ‘현실적 전략’을 세우고 철저히 계획을 지키며 나아갑니다. 독립적인 성향이 강해 ‘나 홀로’ 도전을 즐기며, 실용적인 성과를 중요시합니다. 무턱대고 위험을 감수하지 않고, 계획된 리스크 안에서 최대한의 성과를 뽑아내는 것이 특징입니다. 혼자서도 자신만의 세상에 빠져들어 문제를 해결하고, 차분히 결과를 만들어내는 타입입니다"
          : mbti === "ROIA"
          ? "실용적 독고다이는 빠르게 기회를 포착하고 독립적으로 실용적인 결과를 추구합니다. 높은 위험을 감수하면서도 실질적인 성과에 집중하는 창업자 유형으로, 독립적인 결단력이 강점입니다."
          : mbti === "SPTC"
          ? "안전지향 창의 협력자는 안정적인 환경에서 팀과 협력하여 창의적인 아이디어를 계획적으로 실현하는 유형입니다. 창의성과 협업을 조화롭게 활용하면서 신중하게 성과를 쌓아 나갑니다."
          : mbti === "SPIA"
          ? "독립적 실용 전략가는 안정적인 환경 속에서도 독립적으로 실용적인 전략을 계획하고 실행하는 유형입니다. 리스크를 최소화하면서도 실질적인 성과를 추구하는 창업자에게 잘 맞습니다."
          : mbti === "RPTA"
          ? "모험적 팀 실용주의자는 팀과 함께 실용적 목표를 위해 계획적으로 위험을 감수하는 유형입니다. 팀 협력을 통해 실용적이고 구체적인 목표를 달성하고자 하며, 안전한 성장을 도모합니다."
          : mbti === "SOIC"
          ? "안정적 독립 기회포착형은 안정을 추구하면서도 창의적인 기회를 독립적으로 포착하는 균형 잡힌 유형입니다. 창의성과 안정성을 동시에 중요시하는 창업자에게 적합하며, 신중하면서도 혁신적인 접근이 특징입니다."
          : mbti === "SOTA"
          ? "실용적 팀 기회주의자는 팀과 함께 실용적 가치를 중심으로 안정적으로 기회를 포착하는 유형입니다. 협력을 통해 실질적인 성과를 이루며, 팀워크를 통해 안정적인 성장을 추구합니다."
          : mbti === "RPIC"
          ? "독립적 모험 계획가는 위험을 감수하면서도 독립적으로 창의적인 계획을 세우고 실행하는 유형입니다. 도전적이면서도 창의적인 비전을 가진 창업자에게 적합하며, 스스로 목표를 세우고 빠르게 실행해 나갑니다."
          : mbti === "SPTA"
          ? "실용적 팀 혁신가는 팀과 함께 실용적인 혁신을 추구하며, 계획적으로 위험을 감수하는 유형입니다. 팀의 협력을 통해 실용적 목표를 이루고자 하며, 신중하면서도 혁신적인 접근이 특징입니다."
          : "",
    };
