...
const PageMarketingNoItemsShare = () => {
    ...
    const mbtiResult = {
      ...
      summary:
        mbtiType === "ROIC"
          ...
          : mbtiType === "RPTC"
          ? "🤝 당신은 력과 창의성으로 혁신을 만들어내는 팀플레이어입니다."
          : mbtiType === "ROTA"
          ? "🚀 당신은 팀의 성공을 자신의 성공보다 더 중요하게 여깁니다. 팀원들과 협력하며 목표를 정하고, 모든 자원을 효율적으로 활용해 빠르게 성장합니다. 높은 위험에도 불구하고 팀워크와 조직력을 믿고 돌진하는 이들의 도전정신, 대단하지 않나요? 목표 달성엔 팀이 최강이라는 믿음을 가진 타입입니다. 협력 속에서 성과를 극대화하며 도전과 성장을 함께 이루는 유형입니다."
          : mbtiType === "SPIC"
          ? "🧩 당신은 천천히, 하지만 확실하게 나아가는 퍼즐 조각 장인정신 스타일입니다."
          : mbtiType === "SOTC"
          ? "🛠️ 당신은 과 함께 기회를 찾아 도전하는 현장 감독 스타일입니다."
          : mbtiType === "RPIA"
          ? "🎯 당신은 자서도 모든 걸 해내는 올인원 전략가입니다."
          : mbtiType === "ROIA"
          ? "🏗️ 당신은 율과 실용성을 중시하는 독립형 빌더입니다."
          : mbtiType === "SPTC"
          ? "🌱 당신은 항의성과 안전성을 모두 잡는 정원사 스타일입니다."
          : mbtiType === "SPIA"
          ? "🧠 당신은 독립적으로 완벽한 계획을 실행하는 두뇌파 전략가입니다."
          : mbtiType === "RPTA"
          ? "⚡ 당신은 과 함께라면 뭐모험도 즐기는 다이내믹 플레이어입니다."
          : mbtiType === "SOIC"
          ? "🔍 당신은 기회를 놓치지 않으면서도 안정적으로 성과를 만들어내는 탐정 스타일입니다."
          : mbtiType === "SOTA"
          ? "🛡️ 당신은 워크로 기회를 만들어내는 안정성의 수호자입니다."
          : mbtiType === "RPIC"
          ? "🗺️ 당신은 의적 아이디어로 새로운 길을 개척하는 탐험가입니다."
          : mbtiType === "SPTA"
          ? "💡 당신은 과 함께 창의적이고 실용적인 결과를 만들어내는 발명가 스타일입니다."
          : "",
      description:
        mbtiType === "ROIC"
          ...
          : mbtiType === "ROTA"
          ? "\"팀과 함께 리는 야심가\"는 팀의 성공을 자신의 성공보다 더 중요하게 여깁니다. 팀원들과 협력하며 목표를 정하고, 모든 자원을 효율적으로 활용해 빠빠르게 성장합니다. 높은 위험에도 불구하고 팀워크와 조직력을 믿고 돌진하는 이들의 도전정신, 대단하지 않나요? 목표 달성엔 팀이 최강이라는 믿음을 가진 타입입니다. 협력 속에서 성과를 극대화하며 도전과 성장을 함께 이루는 유형입니다."
          : mbtiType === "SPIC"
          ? "\"차근차근 아이디어 매니아\"는 느리지만 확실한 접근을 선호합니다. 창의적인 아이디어를 다듬고, 꼼꼼하게 검토한 후 실행에 옮기는 안정성을 갖추고 있죠. 단기 성과보다는 장기적인 성장을 목표로 하며, 작은 성공을 쌓아가며 지속 가능한 결과를 만들어냅니다. 리스크를 최소화하면서도 창의성을 발휘할 수 있는 환경에서 진가를 발휘하는 유형입니다."
          : mbtiType === "SOTC"
          ? "\"기회형 팀 전자\"는 팀워크와 협력을 통해 모든 문제를 해결하는 데 최적화된 유형이에요. \"위험이 있다고? 팀이랑 하면 다 해결되지!\"라는 마인드로 어려운 상황에서도 창의적인 아이디어를 실행합니다. 이들은 팀원들의 의견을 잘 수렴하고, 모두가 힘을 합칠 수 있는 환경을 만들어내며, 무슨 일이든 팀으로 돌파합니다. 도전과 안정성을 동시에 챙기며, 팀원들과 함께 목표를 이루는 과정에서 에너지를 얻는 진정한 협력형 플레이어입니다."
          : mbtiType === "RPIA"
          ? "\"혼자서도 멋 현실주의 전략가\"는 \"내가 내 길을 만든다!\"라는 독립적인 사고방식을 가진 전략가입니다. 혼자서도 모든 걸 척척 해내며, 현실적이고 실용적인 해결책을 찾아 실행합니다. 철저한 계획과 사전 준비는 이들의 필수 무기! 장기적인 성과를 위해 단기적인 리스크는 과감히 피하고, 효율적인 방법으로 결과를 만들어냅니다. 독립적인 환경에서 최고의 집중력을 발휘하며, \"혼자 해도 이 정도면 됐지!\"라고 자부할 수 있는 타입입니다."
          : mbtiType === "ROIA"
          ...
          : mbtiType === "SPTA"
          ? "\"실용적 팀 신가\"는 \"같이 하면 더 멀리 간다\"는 신념으로 팀원들과 협력해 실용적이면서도 창의적인 해결책을 만들어냅니다. 체계적인 계획과 현실적인 접근 방식을 통해 안정적이고 효율적인 성과를 만들어내며, 팀의 의견을 조율하고 함께 목표표를 이루는 데 강점을 발휘합니다. 창의성과 현실성, 둘 다 잡는 완벽한 팀플레이어입니다."
          : "",
    };
  ...
  const getMbtiImage = (mbtiName) => {
    switch (mbtiName) {
      case "ROIC": return images.ImgMBTIROIC;
      case "ROIA": return images.ImgMBTIROIA;
      case "ROTC": return images.ImgMBTIROTC;
      case "ROTA": return images.ImgMBTIROTA;
      case "RPIA": return images.ImgMBTIRPIA;
      case "RPIC": return images.ImgMBTIRPIC;
      case "RPTA": return images.ImgMBTIRPTA;
      case "RPTC": return images.ImgMBTIRPTC;
      case "SOIA": return images.ImgMBTISOIA;
      case "SOIC": return images.ImgMBTISOIC;
      case "SOTA": return images.ImgMBTISOTA;
      case "SOTC": return images.ImgMBTISOTC;
      case "SPIA": return images.ImgMBTISPIA;
      case "SPIC": return images.ImgMBTISPIC;
      case "SPTA": return images.ImgMBTISPTA;
      case "SPTC": return images.ImgMBTISPTC;
      default: return "";
    }
  };
