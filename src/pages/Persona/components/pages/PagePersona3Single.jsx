    ...
    if (interviewModeType === "selfQuestion") {
      ...
      const selectedPurpose = {
        ...
        custom_theory_data: {
            ...
            expected_result: "사용자의 관심사와 목적에 최적화된 인터뷰를 통해 더욱 실질적이고 구체적인 인사이트를 도출하며, 자유로운 대화 속에서 새로운 관점과 개선 기회를 발견합니다.",
            interview_purpose: "사용자가 직접 설계한 질문을 통해 페르소나의 경험과 니즈를 심층적으로 이해하고 새로운 인사이트 도출",
            question_list: [
                {
                    question_type: "특화질문",
                    question: "자율 인터뷰에서 어떤 유형의 질문이 가장 효과적인 답변을 이끌어내나요?"
                },
                {
                    question_type: "특화질문",
                    question: "자유로운 대화 흐름 속에서 발견한 예상치 못한 인사이트는 무엇이었나요?"
                },
                {
                    question_type: "특화질문",
                    question: "자율 인터뷰를 통해 얻은 피드백이 기존 인터뷰 방식과 비교했을 때 어떤 차이가 있나요?"
                },
                {
                    question_type: "특화질문",
                    question: "자율 인터뷰 진행 시 가장 중요하게 고려해야 할 점은 무엇이라고 생각하나요?"
                }
            ]
        }
      };
