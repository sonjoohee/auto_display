            ...
            <ProjectList>
              ...
              <ProjectContent>
                {projectList.map((project, index) => (
                  <ProjectItem key={index} $isOpen={openStates[index]}>
                    <ProjectInfo>
                      <Name>
                      ...
                      <Persona>
                        <div>
                          <span>기본형</span>
                          <p>
                            {project.personaList?.unselected?.length || 0}명
                          </p>
                        </div>
                        <div>
                          <span>커스터마이즈</span>
                      ...
                      <Recruit>
                        <span>
                          {project.requestPersonaList?.persona?.length || 0}개
                          페르소나
                        </span>
                    ...
                    {openStates[index] && (
                      <ProjectButton>
                        ...
                        <button
                          onClick={() => navigate(`/Persona/${project._id}`)}
                        >
                          바로가기
                        </button>
                      </ProjectButton>
                    ...
                    {openStates[index] && (
                      <ProjectView
                        className={closingStates[index] ? "closing" : ""}
                      >
                        {project.projectReportList &&
                        project.projectReportList.length > 0 ? (
                          project.projectReportList.map(
                            (report, reportIndex) => (
                              <ViewInfo key={reportIndex}>
                                ...
                                <div className="info">
                                  ...
                                  <div>
                                    <span>참여페르소나</span>
                                    <p>
                                      {project.personaList?.selected?.length ||
                                        0}
                                      명
                                    </p>
                                  </div>
