          ...
          <IdeaGeneratorWrap>
            <TabWrapType5>
              ...
              >
                <span>02</span>
                <div className="text">
                  <Body1 color={activeTab >= 2 ? "gray800" : "gray300"}>타겟 세그먼트</Body1>
                  <Body1 color={activeTab >= 2 ? "gray800" : "gray300"}>Customer Segment</Body1>
                </div>
              </TabButtonType5>
              <TabButtonType5 
              ...
              >
                <span>03</span>
                <div className="text">
                  <Body1 color={activeTab >= 3 ? "gray800" : "gray300"}>아이디어 도출</Body1>
                  <Body1 color={activeTab >= 3 ? "gray800" : "gray300"}>Idea Generation</Body1>
                </div>
              </TabButtonType5>
              <TabButtonType5 
            ...
            {activeTab === 1 && (
              <TabContent5>
                <div className="title">
                  ...
                  <Body3 color="gray800">다양한 아이디어를 발산하고자 하는 핵심 키워드를 입력하세요</Body3>
                </div>
            ...
            {activeTab === 2 && completedSteps.includes(1) && (
              <TabContent5>
                <div className="title">
                  ...
                  <Body3 color="gray800">비즈니스에 적합한 타겟 고객을 중심으로 최적화된 아이디어 도출을 진행해보세요</Body3>
                </div>
                ...
                <SegmentContent>
                  <div>
                    ...
                    <CardGroupWrap row>
                      <ListBoxItem active={selectedInterviewType === "yesTarget"}>
                        <ListText>
                          <ListTitle>
                            <Body1
                              color={
                        ...
                        <div>
                          <RadioButton
                            ...
                            onChange={() => handleInterviewTypeSelect("yesTarget")}
                          />
                        </div>
                      </ListBoxItem>

                      <ListBoxItem active={selectedInterviewType === "noTarget"}>
                        <ListText>
                          <ListTitle>
                            <Body1
                              color={
                        ...
                        <div>
                          <RadioButton
                            ...
                            onChange={() => handleInterviewTypeSelect("noTarget")}
                          />
                        </div>
                      </ListBoxItem>
                    </CardGroupWrap>
                    ...
                    <>
                      <CardGroupWrap>
                        ...
                        >
                          ...
                          <ListText>
                            <ListTitle>
                              <Body1 color={selectedPersonas.includes('persona2') ? "primary" : "gray800"}>
                                가족과 함께 여가를 보내는 활동 지향형 소비자
                              </Body1>
                            </ListTitle>
            ...
            {activeTab === 3 && completedSteps.includes(2) && (
              <TabContent5>
                <div className="title">
                  ...
                  <Body3 color="gray800">비즈니스 핵심가치를 중심으로 체계화된 방법으로 수많은 아이디어를 도출해드려요</Body3>
                </div>
            ...
            {activeTab === 4 && completedSteps.includes(3) && (
              <TabContent5 Small>
                <BgBoxItem primaryLightest>
                  ...
                  <Body3 color="gray800">구조화된 창의적 사고 프로세스를 통해 새로운 기회를 찾아보세요</Body3>
                </BgBoxItem>
                ...
                <InsightAnalysis>
                  ...
                  <div className="content">
                    <H4 color="gray800">
                      (Business)의 타겟분석결과<br />
                      OOO, OOO, OOO의 요인의 우선순위가 높았습니다. 
                    </H4>

                    <Body3 color="gray700">
                      비즈니스 핵심가치 10개를 중심으로 각 가치별 6개의 가치를 적용하여 총 100개의 아이디어를 도출 할 수 있었습니다. (Business)에 대한 분석 내용과 어떤 부분을 참고해서 봐야한다는 부분을 제시하면 좋을 듯 
                    </Body3>
                ...
                {activeAnalysisTab === "summary" ? (
                  <TabContent5Item>
                    <div className="title">
                      <Body1 color="gray800" align="left">🎯 우선순위가 높은 아이디어를 선정해보았어요</Body1>
                    </div>
                    ...
                    <IdeaRankingTable>
                      <Table>
                        <TableHeader>
                          <tr>
                            <th></th>
                            <th><Body1 color="gray800">시장 규모/성장성성</Body1></th>
                            <th><Body1 color="gray800">상품 컨셉 매력도</Body1></th>
                            <th><Body1 color="gray800">구현 가능성</Body1></th>
                            <th><Body1 color="gray800">차별성</Body1></th>
                          </tr>
                        </TableHeader>
                        <TableBody>
                          {data.map((val, key) => (
                            <tr key={key}>
                              <th><Body3 color="gray700">{val.title}</Body3></th>
                              <td><Body3 color="gray700">{val.marketSize}</Body3></td>
                              <td><Body3 color="gray700">{val.productConcept}</Body3></td>
                              <td><Body3 color="gray700">{val.implementability}</Body3></td>
                              <td><Body3 color="gray700">{val.uniqueness}</Body3></td>
                            </tr>
                          ))}
                        </TableBody>
                      </Table>
                  ...
                  <TabContent5Item>
                    <Body1 color="gray800">Reach and engagement of campaigns</Body1>
                  </TabContent5Item>
                )}
          ...
          title={
            <>
              <H4 color="gray800" align="left">
                (Key Value)의 (Business)<br />아이디어 도출하기기
              </H4>
            </>
          }
          buttonType="Fill"
              ...
              {activeTabIndex === 0 && (
                <SunburstChart>
                  <ZoomableSunburst 
                    ...
                    width={700} 
                    height={700} 
                    colors={['#A88CCC', '#D98ACF', '#FE93B5', '#FFAE91', '#EED482', '#CFF69D', '#97FAA4', '#77ECC8', '#7BCDE8', '#94A8E9']} 
                  />
                </SunburstChart>
              )}
                  ...
                  <ListBox>
                    <div>
                      ...
                      <div>
                        ...
                        <Body2 color="gray700" align="left">
                          이 비즈니스 아이템은 참신하고 현재의 시장 동향과 맞아떨어집니다. 특히 비대면 교육과 시니어 맞춤형 디지털 플랫폼의 필요성이 증가하는 상황에서 유망한 성장 기회를 가집니다.
                        </Body2>
                        <ul className="ul-list">
                          <li><Body2 color="gray700" align="left">아이디어 1 : 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명 아이디어 설명</Body2></li>
                          <li><Body2 color="gray700" align="left">아이디어 1 : 아이디어 설명</Body2></li>
                          <li><Body2 color="gray700" align="left">아이디어 1 : 아이디어 설명</Body2></li>
                          <li><Body2 color="gray700" align="left">아이디어 1 : 아이디어 설명</Body2></li>
                          <li><Body2 color="gray700" align="left">아이디어 1 : 아이디어 설명</Body2></li>
                          <li><Body2 color="gray700" align="left">아이디어 1 : 아이디어 설명</Body2></li>
