                  ...
                  <CardGroupWrap>
                    {customerValueAnalyzerPersona.map((content, index) => (
                      <MoleculeCustomerValueCard
                        ...
                        isSelected={selectedPersonas.includes(
                          `persona-${index}`
                        )}
            ...
            {activeTab === 4 && completedSteps.includes(3) && (
              <TabContent5 Small>
                ...
                <InsightAnalysis>
                  ...
                  <div className="content">
                    <H4 color="gray800">
                      페르소나별 고객 여정 분석 결과, 임신·육아 정보 플랫폼의
                      핵심 구매 요소는
                      <br />
                      신뢰성 높은 전문가 상담, 체계적인 정부 지원 안내, 그리고
                      개인 맞춤 큐레이션으로 분석됩니다.
                    </H4>

                    <Body3 color="gray700">
                      첫째, 정보 신뢰성 부족으로 인해 고객들은 부정확한 정보를
                      접하거나 전문가 상담이 지연되는 문제를 겪고 있다. 특히
                      출산을 앞둔 산모나 다둥이 부모는 검증된 전문가의 실시간
                      답변을 원하지만, 플랫폼 내 상담 속도와 신뢰성에 대한
                      불만족도가 높다. 둘째, 육아 지원 서비스 부족으로 고객들은
                      시간과 비용의 부담을 크게 느낀다. 다둥이 부모의 경우 믿을
                      수 있는 육아 도우미 매칭이 어렵고, 정부 지원 정보도
                      산발적으로 제공되어 실질적인 도움을 받지 못하고 있다.
                      셋째, 개인 맞춤형 정보 부족이 고객의 피로감을 유발한다.
                      임신/출산/육아 단계별로 필요한 정보가 다르지만, 대부분의
                      플랫폼은 일반적인 정보를 나열하는 수준에 그쳐 사용자가
                      원하는 정보를 찾기 어려운 구조다.
                    </Body3>

                    <Body3 color="gray700">
                      AI 기반 전문가 상담 시스템을 도입하여 고객이 1분 내 신뢰할
                      수 있는 답변을 받을 수 있도록 개선한다. 전문가의 즉각적인
                      응답이 가능한 "AI+전문가 하이브리드 모델"을 구축해 상담
                      대기 시간을 단축하고, 의료진과의 협업을 통해 신뢰도를
                      보장해야 한다. 육아 도우미 매칭 및 지원금 연계 서비스를
                      플랫폼 내에서 제공하여, 고객이 검증된 도우미를 직접
                      연결하고 정부 지원 혜택을 손쉽게 확인할 수 있도록 한다.
                      이는 사용자 충성도를 높이고 유료 서비스로 확장할 수 있는
                      기회를 제공한다. 마지막으로 AI 맞춤형 정보 큐레이션을 통해
                      사용자의 관심사, 임신 주수, 육아 스타일을 분석하여 개별
                      맞춤형 정보를 자동 제공하는 시스템을 구축해야 한다. 이를
                      통해 사용자는 원하는 정보를 신속하게 찾을 수 있으며,
                      플랫폼에 대한 의존도가 증가해 장기적인 사용자 유지율을
                      높이는 비즈니스 기회를 창출할 수 있다.
                    </Body3>
                  </div>
                </InsightAnalysis>
                ...
                <ValueMapWrap>
                  <div>
                    ...
                    <BoxWrap Column>
                      <Body3 color="gray700">
                        가로축 (X축) - 영향력 : 많은 사람들이 중요하게 여기는
                        구매 결정 요인의 영향 정도
                      </Body3>
                      <Body3 color="gray700">
                        세로축 (Y축) - 불만족도 : 사람들이 해당 구매 요인에 대해
                        불만족을 느끼는 정도{" "}
                      </Body3>
                    </BoxWrap>
                  </div>
                  ...
                  <ValueMap>
                    ...
                    <div className="content">고객경험 & 핵심 가치 맵맵</div>
                  </ValueMap>
                </ValueMapWrap>
