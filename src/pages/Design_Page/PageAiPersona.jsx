      ...
      <ContentsWrap>
        ...
        <MainContent Wide1240>
          <AiPersonaWrap>
            <AiPersonaTitle>
              <div>
                <H1 color="gray800" align="left">AI Persona</H1>
                <Body3 color="gray700" align="left">
                  당신의 비즈니스에 새로운 인사이트를 제시해줄 AI 페르소나가 대화를 기다리고 있어요 
                </Body3>
              </div>
            ...
            <AiPersonaContent>
              ...
              <AiPersonaInfo>
                <div>
                  <span className="active"><Sub3 color="primary">1</Sub3></span>
                  <Sub3 color="gray700">활성 페르소나</Sub3>
                </div>
                <div>
                  <span className="inactive"><Sub3 color="primary">15</Sub3></span>
              ...
              <AiPersonaCardGroupWrap>
                <AiPersonaCardListItem>
                  ...
                  <div className="content">
                    <Sub3 color="gray700">스마트홈 기기와 연동하여 알람을 자동화하고, 커스텀 기능을 연구, 스마트홈 기기와 연동하여 알람을 자동화하고, 커스텀 기능을 연구 스마트홈 기기와 연동하여 알람을 자동화하고, 커스텀 기능을 연구, 스마트홈 기기와 연동하여 알람을 자동화하고, 커스텀 기능을 연구</Sub3>
                  </div>

                  <AiPersonaCardButtonWrap>
                    <div>
                      <StarButton onClick={() => setIsStarred(!isStarred)} isStarred={isStarred}>
                        {isStarred ? (
            ...
            <div style={{ maxWidth: "560px" }}>
              ...
              <div className="content">
                ...
                {activeTab2 === "lifestyle" && (
                  <TabContent>
                    <Body3 color="gray700">학업과 여가를 균형 있게 추구하며, 문화적 호기심이 많습니다. 대학 근처의 문화 공간을 자주 방문하며, 예술 전시와 독립영화를 감상하거나 워크숍에 참여합니다. 소셜 미디어를 통해 최신 문화 소식을 빠르게 접하고, 친구들과 경험을 공유하는 것을 즐깁니다. 새로운 시도를 통해 자기 계발을 추구하며, 학업과 관련된 창의적 활동에도 열정적입니다.학업과 여가를 균형 있게 추구하며, 문화적 호기심이 많습니다. 대학 근처의 문화 공간을 자주 방문하며, 예술 전시와 독립영화를 감상하거나 워크숍에 참여합니다. 소셜 미디어를 통해 최신 문화 소식을 빠르게 접하고, 친구들과 경험을 공유하는 것을 즐깁니다. 새로운 시도를 통해 자기 계발을 추구하며, 학업과 관련된 창의적 활동에도 열정적입니다.</Body3>
                  </TabContent>
                )}
              ...
              <ButtonGroup>
                <Button DbExLarge PrimaryLightest Fill W100 onClick={() => setIsEditPopupOpen(true)}>
                  페르소나 편집
                </Button>
                <Button DbExLarge Primary Fill W100 onClick={() => setIsCreatePopupOpen(true)}>
                  페르소나 생성
                </Button>
              </ButtonGroup>
            ...
            <div>
              {activeTabIndex === 0 && (
                <>
                  ...
                  <div>
                    <Body2 color="gray700" align="left">
                      맞춤 페르소나를 생성하는 이유와 목적이 무엇인가요?<span style={{ color: "red" }}>*</span>
                    </Body2>
                    <PopupContent>
                      <CustomTextarea
                        width="100%"
                  ...
                  <div>
                    <Body2 color="gray700" align="left">
                      필수적으로 필요한 정보가 있다면, 알려주세요 <span style={{ color: "red" }}>*</span>
                    </Body2>
                    <PopupContent>
                      <CustomTextarea
                        width="100%"
              ...
              {activeTabIndex === 2 && (
                <>
                  <BgBoxItem NoOutline style={{ marginBottom: "10px", alignItems: "flex-start" }}>
                    ...
                    💡 맞춤 페르소나 요청이 많은 경우,
                      <br />
                      페르소나 생성 시간이 다소 길어질 수 있는 점 양해 부탁드립니다.
                      <br />
                      보다 정확하고 정교한 페르소나를 제공해 드릴 수 있도록 최선을 다하겠습니다. 😊
                    </Sub3>
                  </BgBoxItem>
                  ...
                  <div className="flex">
                    ...
                    <div>
                      <Body3 color="gray500" align="left">연령</Body3>
                      <Body2 color="gray800" align="left">20대</Body2>
                    </div>
                  </div>

                  <div>
                    <Body3 color="gray500" align="left">이유, 목적</Body3>
                    <Body2 color="gray800" align="left">여러가지 이유와 목적을 작성하시면 됩니다.<br />해당 내용이 길어질 수 있습니다.</Body2>
                  </div>

                  <div>
                    <Body3 color="gray500" align="left">필수정보</Body3>
                    <Body2 color="gray800" align="left">여러가지 내용이 들어갈 수 있는 다양한 정보를 보여줍니다. 너무 많은 내용은 줄 바꿈이 필요 합니다. 당연히 두줄도 가능 합니다. 너무 많은 내용은 힘들 수 있습니다.<br />물론 세줄까지도!! 가능 할지도 모릅니다. 하지만 이 이상은 정말 힘들기 때문에 자제.. </Body2>
                  </div>

                  <div>
                    <Body3 color="gray500" align="left">성격(OCEAN)</Body3>
...
const StarButton = styled.span`
  ...
  padding: 6px;
  border-radius: 4px;
  border: 1px solid ${props => props.isStarred ? `rgba(255, 149, 0, 0.10)` : palette.gray200};
  background: ${props => props.isStarred ? `rgba(255, 149, 0, 0.10)` : palette.white};
  cursor: pointer;
